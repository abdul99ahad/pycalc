def multiplication(a,b,c,display):  # After pressing "x" button this function will be called
    try:
        ...
        pass
    c = 3  # The fingerprint of multiplication. It will be checked every time when a new function is executed
