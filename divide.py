def division(a,b,c,display):                          # After pressing "÷" button this function will be called
    try:
        ...
        pass
    c = 4  # The fingerprint of division. It will be checked every time when a new function is executed
