def equals(a,b,c,display):  # After pressing "=" button this function will be called
    ...
    if a != 0 and b == 0:  # Now after pressing any operator for the second time,the second input will go to "b",because a != 0 and b == 0
    ...
    c = 5  # The fingerprint of equality. It will be checked every time when a new function is executed
