def subtraction(a,b,c,display):  # After pressing "-" button this function will be called
    try:
        ...
        pass
    c = 2  # The fingerprint of subtraction. It will be checked every time when a new function is executed
